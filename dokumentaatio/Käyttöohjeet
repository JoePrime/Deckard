This game's idea is to have two players using battle cards with varying effects to reduce their opponent's hitpoints to zero.
...
the game. The cards can be used to increase your own or decrease your opponent's health, armor, mana or other resources. Using a card
